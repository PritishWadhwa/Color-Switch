...
public class Gameplay1 extends Application {
    ...
    protected Rectangle rect = makeRectangle(0, 0, 850, 560, Color.rgb(41, 41, 41));
    protected Rectangle rerect = makeRectangle(0, 0, 850, 560, Color.rgb(41, 41, 41));
    protected Circle homeCircle = makeCircle(100, 100, 40, Color.rgb(128, 128, 128));
    protected Circle centerCircle1 = makeCircle(280, 212.5, 70, Color.rgb(88, 88, 88));
    protected Circle centerCircle2 = makeCircle(280, 425, 70, Color.rgb(88, 88, 88));
    protected Circle centerCircle3 = makeCircle(280, 637.5, 70, Color.rgb(88, 88, 88));
    protected ImageView homeImg = makeImage("images/homeButton.png", 70, 70, 60, 60, true);
    protected ImageView restartImg = makeImage("images/restartButton.png", 169, 122, 250, 250, true);
    protected ImageView playImg = makeImage("images/playButton.png", 222, 367, 125, 125, true);
    protected ImageView saveImg = makeImage("images/saveButton.png", 236, 593, 90, 90, true);
    protected Circle rehomeCircle = makeCircle(100, 100, 40, Color.rgb(128, 128, 128));
    protected Circle recenterCircle2 = makeCircle(280, 425, 70, Color.rgb(88, 88, 88));
    protected Circle recenterCircle3 = makeCircle(280, 637.5, 70, Color.rgb(88, 88, 88));
    protected ImageView rehomeImg = makeImage("images/homeButton.png", 70, 70, 60, 60, true);
    protected ImageView rerestartImg = makeImage("images/restartButton.png", 169, 548, 250, 250, true);
    protected ImageView replayImg = makeImage("images/playButton.png", 222, 367, 125, 125, true);
    protected String musicFile = "images/tap.mp3";
    protected String musicFil = "images/die.mp3";
