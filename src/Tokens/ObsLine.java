...
public class ObsLine extends JPanel {
    private Group ob;

    public ObsLine(Pane ro, ArrayList<Shape> nodes,double y) {
        ...
        ra.getKeyFrames().add(new KeyFrame(Duration.seconds(5), new KeyValue(rotateCWCC2.angleProperty(), 0)));
